...
def weather():
    ...
    if not location:
        return render_template("index.html", error="Son! enter a city name")
    try:
        ...
        if not geo_data.get("results"):
            return render_template("index.html", error="City not found Son!")
     ...
     return render_template("index.html", error="Son! Something went wrong because of you")
